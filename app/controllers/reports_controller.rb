  ...
  require 'csv'
	...
	if dec.representative_phone.to_s.strip.empty?
        ...
        (1..1).to_a.each do |sequence|         
            ...
            if minerals[0].goldto_s.strip.downcase == "yes" 
            ...
            else if mq.gold_comment.to_s.strip.empty?
              calc_minerals[sequence][:gold_comment][:"Did not provide comments"] += 1
            else
              calc_minerals[sequence][:gold_comment][:"Provided comments"] += 1
            end
        ...
        csv << ["",
            ...
            "%d Company level - %d Division level - %d Product category level - %d Product level - %d Not Provided" % [calc_declaration_scope[:"Company level"], calc_declaration_scope[:"Division level"], calc_declaration_scope[:"Product category level"], calc_declaration_scope[:"Product level"], calc_declaration_scope[:"Not Provided"]],
            "",
