...
:instructions => <<EOT
<p>Prepare an RCOI Report for Your Firm<br></p><ol><li>Create your Firm's RCOI Report using your Firm's version of the <a href="http://www.conflictfreesmelter.org/ConflictMineralsReportingTemplateDashboard.htm" target="_blank">EICC-GeSI Conflict Mineral Reporting Template</a> Declaration Statement.<br><ol start="1" style="list-style-type: lower-alpha;"><li>For instructions on how to create this declaration statement, go to <a href="http://www.youtube.com/watch?v=5_LlwuBVcOE" target="_blank">YouTube instruction video on how to use the MRPRO Dashboard</a><br></li><li>You must take into account the "reasonableness" of each Supplier's RCOI. (For a discussion of what is meant by "reasonableness," refer in the Reference Materials section at the end of this worksheet to <a href="http://www.youtube.com/watch?v=5_LlwuBVcOE" target="_blank"><em>Reasonable Country of Origin Inquiry</em></a>.)</li></ol></li></ol>
