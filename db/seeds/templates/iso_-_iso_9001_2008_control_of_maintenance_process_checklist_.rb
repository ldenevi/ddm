...
:instructions => <<EOT
1.	Identify the process owner who can properly describe the process and quality metrics for the Control of Maintenance (CM).  In the workspace below, provide the process owner’s name, title, date interviewed and state why this individual is qualified to participate in the CM quality management review.  
2.	Document the process owner’s description of your organization’s CM Process, highlighting preventative maintenance, equipment failure repair and spare parts management.
...
:name => "CM Metrics",
:instructions => <<EOT
1.	Document the CM process owner’s verbal answers to the following questions:
a.	What metrics do you use to evaluate the effectiveness of the CM process?
...
:instructions => <<EOT
1.	Interview operational personnel to determine whether the maintenance process is effective. Record any opportunities for improvement.
...
:instructions => <<EOT
1.	Who performs required maintenance on the equipment?  Document their positions/titles.
...
:instructions => <<EOT
1.	Interview each new employee identified in Task 5-5 above and document his/her answer to the following questions:
...
:instructions => <<EOT
1.	What types of documents are used in the CM Process? (These may include the preventive maintenance (PM) schedule, Operator Work Instructions, OEM equipment manuals, etc.)
a.	Note which of these are external documents, such as supplier material/part specifications and how they are identified as external documents.
...
a.	Are spare parts available when they are needed?
b.	Are the tools adequate for the process?
c.	Is the hardware and software used in the process adequate to meet the needs of process participants?
2.	Is the work environment suitable for the Maintenance process?
...
:instructions => <<EOT
1.	What records are generated by the CM process?
...
:instructions => <<EOT
1.	For a sampling of employees responsible for the CM Process:
...
2.	Summarize your evaluation of whether or not the quality goals and objectives have been adequately communicated to the personnel responsible for CM Process.
