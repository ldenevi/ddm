# encoding: UTF-8
puts "Creating Conflict Minerals Due Diligence for Non-Filing Electronics Industry Manufacturers: Third Party Audit of Smelters/Refiners Due Diligence Practices ...".force_encoding('UTF-8')
template = GspTemplate.create({:agency => Agency.find_by_acronym('GSP'),
                               ...
                               :description => '',
                               :regulatory_review_name => 'Conflict Minerals Due Diligence for Non-Filing Electronics Industry Manufacturers: Third Party Audit of Smelters/Refiners Due Diligence Practices',
...
:instructions => <<EOT
<ol>
	<li>List the smelters/refiners that your Firm is able to identify as sources of the gold, tin, tantalum and tungsten in the products it manufactures based upon its Reasonable Country of Origin Inquiry and supply chain mapping efforts.</li>
